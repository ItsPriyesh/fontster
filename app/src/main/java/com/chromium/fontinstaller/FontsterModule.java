...
@Module
public final class FontsterModule {
  ...
  @Provides @Singleton FontsterApp providesFontsterApplication() {
    return mApplication;
  }

  @Provides @Singleton FontsterPreferences providesFontsterPreferences() {
